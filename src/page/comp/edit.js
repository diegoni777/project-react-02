...
export default class Register extends React.Component{
        ...
        subForm=(event)=>{
            ...
            fetch('http://localhost/react03/public/api/put01/'+this.state.alumno.id,
            {method:'PUT',
            headers:{
            ...
            <div className="container" style={{maxWidth:"750px"}}>
                ...
                <form onSubmit={this.subForm}>
                    <div className="form-group">
                        ...
                        defaultValue={alumno.nombre} onChange={this.changeField}/>
                    </div>
                    <div className="form-group">
                        <label>Apellido paterno:</label>
                        <input type="text" className="form-control" name="app"
                        defaultValue={alumno.app}  onChange={this.changeField}/>
                    </div>
                    <div className="form-group">
                        <label>Fecha N:</label>
                        <input type="date" className="form-control" name="fn" 
                        defaultValue={alumno.fn}onChange={this.changeField}/>
                    </div>
                    <div className="form-group">
                        ...
                        <div className="custom-control custom.radio custom-control-inline">
                            <input type="radio" className="custom-control-input" id="rgenero01" name="genero" 
                            value="0" onClick={this.changeField} defaultChecked/>
                            <label className="custom-control-label" htmlFor="rgenero01">Femenino</label>
                        </div>
                        <div className="custom-control custom.radio custom-control-inline">
                            <input type="radio" className="custom-control-input" id="rgenero02" name="genero" 
                            value="1" onClick={this.changeField}/>
                        ...
                        <div className="custom-control custom.radio custom-control-inline">
                            <input type="radio" className="custom-control-input" id="rgenero01" name="genero" 
                            value="0" onClick={this.changeField} />
                            <label className="custom-control-label" htmlFor="rgenero01">Femenino</label>
                        </div>
                        <div className="custom-control custom.radio custom-control-inline">
                            <input type="radio" className="custom-control-input" id="rgenero02" name="genero" 
                            value="1" onClick={this.changeField}defaultChecked/>
                            <label className="custom-control-label" htmlFor="rgenero02">Masculino</label>
                        </div>
                        </div>
                        }
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control" id="sGroup" name="id_grupo" onChange={this.changeField}>
                            ...
                            <option value={grupo.id_grupo} key={i}>
                                {(grupo.id===alumno.id_grupo)?
                                "-- ---"+grupo.id + " "+grupo.clave+" - "+grupo.nombre +"-- --"
                                :+grupo.id + " "+grupo.clave+" - "+grupo.nombre}
                                </option>
                            )}
                        </select>
                    ...
                    <div className="form-group">
                        ...
                        defaultValue={alumno.img} onChange={this.changeField}/>
                    </div>
                        <br/>
                        <button type="submit" className="btn bt-primary">Editar</button>
                </form>
                <Link to='/'>
